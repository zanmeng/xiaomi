...
<div class="x-body">
    <div class="layui-row">
        {{--<form class="layui-form layui-col-md12 x-so" action="/admin/user" method="get">--}}
            ...
            {{--<input type="text" name="username" value="{{$username or ''}}" placeholder="请输入用户名" autocomplete="off" class="layui-input">--}}
    ...
    <table class="layui-table">
        ...
        <tr>
            ...
            <td class="td-manage">
                ...
                <a title="编辑"  onclick="x_admin_show('编辑','{{url('admin/'.$v->login_id.'/edit')}}',600,400)" href="javascript:;">
                    <i class="layui-icon">&#xe642;</i>
                </a>
