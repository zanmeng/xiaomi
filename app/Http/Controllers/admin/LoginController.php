...
//        return $str1;
        ...
        //解密
//        $str = 'eyJpdiI6Im5XXC9aWXQ1ZFpSaWZ3UENzdWpaNm9RPT0iLCJ2YWx1ZSI6IlZFMDF6M1ZsdEtWbU5JRGFIT1EySFE9PSIsIm1hYyI6IjU0M2EwYWQ1MGVhMDVmNTNmOTA0MDBmZGU2YWFhOTQ0MWIxMDc5ZWZhNDRkMzc4ZDI5MDEyODg4ZDY5ZWU4ODkifQ==';
//        $str2 = Crypt::decrypt($str);
//        return $str2;
...
//        $str1 = Hash::make($str);
//
//        $str2 = '$2y$10$Totgc3CRtZ0YItBi4OjL1.aFaXs1IPc7FYvr9DzCmoggccpkERxYC';
//
//        if(Hash::check($str,$str2)){
//
//            return '密码正确';
//
//        }else{
